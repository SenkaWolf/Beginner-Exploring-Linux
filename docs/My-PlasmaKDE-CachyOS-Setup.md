...
- Firmware: `yay -Syu`
- Tools: `yay -S ttf-raleway ungoogled-chromium-bin qdirstat-bin qdiskinfo-bin nordvpn-bin nordvpn-gui-bin rustdesk-bin wtf wtfutil-bin vicinae-bin peaclock solaar rclone-browser`
