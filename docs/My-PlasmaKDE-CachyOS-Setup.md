...
- Tools: `sudo pacman -Sy flatpak yay snapper snap-pac grub-btrfs cachy-update zen-browser stow qbittorrent ghostty starship htop btop cpu-x gparted openrgb k3b cmatrix strace`
