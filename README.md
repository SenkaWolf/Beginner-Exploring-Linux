...
This is a list of distributions which I have explored when learning Linux. Any marked with a ![Star](https://github.com/senkawolf/Beginner-Exploring-Linux/blob/main/media/star14.png?raw=true) is a distro I recommend.
